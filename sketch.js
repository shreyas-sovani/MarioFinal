...
var marioImg,mario,bgImg,marioImg1,marioWin;
...
var turtleImg,turtle,turtleGrp;
...
function preload(){
    ...
    marioWin=loadImage("mario00.png");
    turtleImg=loadImage("turtleNobg.png");
...
if(mario.isTouching(obstaclesGrp) || mario.isTouching(turtleGrp)){
    GAMESTATE="END";
dieSound.play();
...
if(GAMESTATE==="WIN"){
   ...
   // if(keyDown("right")){
    ...
    obstaclesGrp.setVelocityXEach(0);
    coinsGrp.setVelocityXEach(0) ;
    mario.addAnimation("mario",marioWin);
    obstacles.addAnimation("obstacleAnimation",obstaclesImg1);
...
coins1=createSprite(720,random(220,350),1,1);
    coins1.velocityX=-(6 + 3*score/100);
    ...
    coins2.velocityX=-(6 + 3*score/100);
    ...
    coins3.velocityX=-(6 + 3*score/100);
    ...
    coins4.velocityX=-(6 + 3*score/100);
...
function turtles(){
    if(frameCount%150===0){
        ...
        turtle=createSprite(700,387,1,1);
        turtle.addImage(turtleImg);
        turtle.scale=0.1
        turtle.velocityX=-4
        turtleGrp.add(turtle); 
       // turtle.velocityX=-5
